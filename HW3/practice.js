...
import { GUI } from '../node_modules/three/examples/js/libs/dat.gui.min.js';
...
const urls = [
  r + 'negx.jpg', r + 'negy.jpg',
  r + 'negz.jpg', r + 'posx.jpg',
  r + 'posy.jpg', r + 'posz.jpg'
];

//const textureCube = new THREE.CubeTextureLoader().load( urls );
//textureCube.mapping = THREE.CubeRefractionMapping;
//textureCube.mapping = THREE.CubeReflectionMapping;
//cubeMap 대신 EquirectangularReflectionMapping 사용
...
const material = new THREE.RawShaderMaterial( {
  uniforms: {
    //time: { value: 1.0 },
    lightPos:{value:(30, 30, 30)},
    lightColor: {value:'#0xFF00FF'},
    objColor: {value:'#0x40FFFF'},
    ambientColor: {value:'#0x404040'},
    shininess: {value: 30},
...
var options={
  'shininess: 30': function(){
  //초기값 설정
  this.shininess=30; 
  },
  'shininess: 200': function(){
    //초기값 설정
    this.shininess=200; 
    }
} //shininess 는 30, 200 에 대해 렌더링 결과를 보임

const gui= new GUI();
gui.add(options, 'shininess: 30');
gui.add(options, 'shininess: 200');
