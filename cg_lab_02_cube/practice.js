...
//중첩 vtx 사용 시: 점 각자의 nm 가짐  <-> vtx 4개 갖게 하기: 각 plane의 평균값 사용(computeVertexNormals)
...
// line model 
const myMesh = new THREE.Mesh( geometry, material );  //nm 별도 계산 필요 
...
const myMesh2 = new THREE.Mesh(
  new THREE.SphereGeometry( 5, 16, 8 ),  //three.js 자체 제공: 잘 정의됨(atrb, nm + ..)
