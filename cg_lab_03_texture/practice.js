...
myLight.target = cube;  //cube 보고 따라다님
scene.add(myLight); 
...
const r = 'txtImg/';
        ...
        //https://github.com/mrdoob/three.js/blob/master/examples/webgl_materials_cubemap_refraction.html
				...
				// textureCube.mapping = THREE.CubeRefractionMapping;  //굴절 
				textureCube.mapping = THREE.CubeRefractionMapping;  //반사
				// textureCube.filter =  mag/mip/Linear 등 존재- 찾아보기

        //https://github.com/mrdoob/three.js/blob/master/examples/webgl_materials_envmaps.html
        //reflection, refraction 은 env map을 mtrl에 줬을 때 반사,굴절 중 어디에 쓸지 결정
        
        const textureEquirec = textureLoader.load( './txtImg/2294472375_24a3b8ef46_o.jpg' );
