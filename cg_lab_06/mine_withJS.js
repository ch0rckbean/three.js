...
const myTex = textureLoader.load( './img.jpeg' );
...
// cube model
const cube = new THREE.Mesh(myGeo, material); // geometry. 구조: medelViewMatrix: Matrix4. vtxShader에서 매핑
...
myLight.target.position.set( 0, 0, 20 );
myLight.target = cube;
scene.add(myLight);

const myAmbLight = new THREE.AmbientLight( 0x404040 ); // soft white light
